...
Mat Embed(Mat& HostImg, Mat& QrImg)
{
 ...
 //   LL_subband = WT_result(Rect(0, 0, WT_result.rows / 2, WT_result.cols / 2)); // LL
	...
	imwrite("[blackgreygradient]DWT_DCT_CRT_LH.png", yuv);
	imwrite("[blackgreygradient]DWT_DCT_CRT_LH_75.jpg", yuv, param75);
	imwrite("[blackgreygradient]DWT_DCT_CRT_LH_95.jpg", yuv, param95);
